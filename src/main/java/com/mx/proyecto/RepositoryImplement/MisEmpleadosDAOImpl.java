...
import com.mx.proyecto.Entity.Empleados2;
...
public class MisEmpleadosDAOImpl extends GenericDAO<MisEmpleados, Integer> implements MisEmpleadosDAO{
	...
	@Override
	@Transactional
	public Integer obtenerValorSecuencia() {
	...
	public List<MisEmpleados> obtieneEmpleados() {
		...
		final Criteria criteria = session.createCriteria(Empleados2.class); // --> select *  from tabla
